    ...
    void EventAction::EndOfEventAction(const G4Event* event)
    {
        ...
        for (G4int iVertex = 0; iVertex < nPrimaries; ++iVertex) {
            ...
            if (primary->GetPDGcode() == 2112) {
                ...
                analysisManager->FillH1(2, fEnergyHormigon);
                analysisManager->FillH1(3, fTrackLHormigon);
                ...
                analysisManager->FillNtupleDColumn(2, fEnergyHormigon);
                analysisManager->FillNtupleDColumn(3, fTrackLHormigon);
