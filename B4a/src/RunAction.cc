...
namespace B4
{
    ...
    RunAction::RunAction()
    {
      ...
      // Creating histograms
        ...
        analysisManager->CreateH1("EdepHormigon", "Edep in hormigon", 300, 0., 3 * MeV);
        analysisManager->CreateH1("LengthHormigon", "trackL in hormigon", 300, 0., 80 * cm);
        analysisManager->CreateH1("EdepBackDetector", "Edep in Back detector", 300, 0., 3 * MeV);
        analysisManager->CreateH1("LegthBackDetector", "trackL in back detector", 300, 0., 80 * cm);

        //Queremos crear un histograma de las posiciones X e Y de las particulas que llegan al detector
        analysisManager->CreateH2("h2", "Posiciones de las particulas en el detector", 1000., -300., 300., 1000., -300., 300.);
        analysisManager->CreateH2("BackDetector", "Posiciones particulas en el backDetector", 1000, -300, 300, 1000, -300, 300);
        ...
        analysisManager->CreateNtupleDColumn("EHormigon");
        analysisManager->CreateNtupleDColumn("LHormigon");
